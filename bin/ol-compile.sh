...
java  -Xmx256M -cp "$APPDIR/../src:$APPDIR/../lib/gwtopenlayers.jar:/home/porter/rhs/gwt/gwt-user.jar:/home/porter/rhs/gwt/gwt-dev.jar" com.google.gwt.dev.Compiler -war "../war" "$@" com.weathertopconsulting.olmapwidget.NativeMapWidget;
