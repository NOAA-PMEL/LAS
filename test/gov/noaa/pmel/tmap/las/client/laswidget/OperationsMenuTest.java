...
public class OperationsMenuTest {
	...
	public void testClickSaveAsButton() {
		...
		driver.get(Messages.getString("Test" + ".baseURL") //$NON-NLS-1$
				...
				+ "/baker/getUI.do"); //$NON-NLS-1$
		WebElement datasetButtonElement = driver.findElement(By.id(Messages
				.getString(thisClassSimpleName + ".DatasetButtonElementID"))); //$NON-NLS-1$
		// TODO: try this click multiple times
		datasetButtonElement.click();
		WebElement ocean_atlas_subset = driver.findElement(By
				.id("ocean_atlas_subset"));
		// TODO: try this click multiple times
		ocean_atlas_subset.click();
		WebElement ocean_atlas_subset_radio = driver
				.findElement(By
						.id("/lasdata/datasets/ocean_atlas_subset/variables/TEMP-ocean_atlas_subset_radio"));
		// TODO: try this click multiple times
		ocean_atlas_subset_radio.click();
		By findSaveAsButtonElementByID = By.id(Messages
				.getString(thisClassSimpleName + ".SaveAsButtonElementID")); //$NON-NLS-1$
		final WebElement saveAsButtonElement1 = driver
		...
		saveAsButtonIsEnabled = new ExpectedCondition<Boolean>() {
			public Boolean apply(WebDriver d) {
