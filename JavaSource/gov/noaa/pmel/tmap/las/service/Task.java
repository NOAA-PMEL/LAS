...
public class Task {
     ...
     */
    public void run() throws LASException {
        ...
        try {
            ...
            if (process == null) {
                throw new LASException("creation of child process "
            ...
            throw new LASException("creation of child process failed\n"
     ...
     */
    public void run(long timeLimit) throws LASException {
        ...
        try {
            ...
            throw new LASException(lase.toString());
        } finally {
     ...
     */
    protected void finish(Process process, long startTime) throws LASException {
        ...
        while (true) {
            try {
                ...
                if (timeLimit > 0 && endTime - startTime > timeLimit * 1000) {
                    ...
                    process.destroy();
                    throw new LASException("process exceeded time limit of "
                            + timeLimit + " sec");
                }
     ...
     */
    protected void checkErrors() throws LASException   {
     ...
     * @throws LASException 
     */
    protected boolean findErrorsInStream(BufferedReader in) throws LASException  {
        String line;
        int i;
        ...
        try {
            ...
            throw new LASException("Script output error scan failed: "
                    + ioe.getMessage());
        }
