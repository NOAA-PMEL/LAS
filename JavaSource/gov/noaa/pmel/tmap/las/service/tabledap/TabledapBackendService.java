...
http://coastwatch.pfel.noaa.gov/erddap2/tabledap/pmel_dapper/tao?
...
"   <data url=\"http://coastwatch.pfel.noaa.gov/erddap2/tabledap/\" \n" +  //required (especially 'url')
...
"</backend_request>\n";
     ...
     *
     * <p>This sample url should be generated by this xml.
http://coastwatch.pfel.noaa.gov/erddap2/tabledap/csc_mwfs/wt?longitude,latitude,altitude,time,sea_water_temperature
...
"   <data url=\"http://coastwatch.pfel.noaa.gov/erddap2/tabledap/\" \n" +  //required (especially 'url')
  "var=\"sea_surface_temperature\" title=\"Sea Surface Temperature\" \n" +
  "xpath=\"/lasdata/datasets/pmel_dapper_tao/variables/sea_surface_temperature\" \n" +  //???
  "dataset_name=\"csc_mwfs_wt\" dataset_ID=\"csc_mwfs_wt\" units=\"degree_C\" \n" + //???
  "name=\"Sea Surface Temperature\" ID=\"csc_mwfs/wt\" \n" +  //???
  "points=\"xyzt\" intervals=\"xyzt\" grid_type=\"scattered\">\n" + //???
"     <region IDREF=\"region_0\" />\n" +
"     <properties>\n" +
"       <property_group type=\"tabledap_access\">\n" +
...
//String requestXml = testRequestXml20080109;
