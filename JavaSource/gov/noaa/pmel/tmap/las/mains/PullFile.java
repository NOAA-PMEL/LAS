    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            try {
                ...
                String q = "traj1,QC_flag,cruise_id,cruise_name,vessel_name,PIs,DOI,obs1,fCO2_recomputed,pressure,pressure_ncep_slp,pressure_equilibrium,salinity,salinity_woa5,temperature,temperature_equilibrium,ETOPO2_depth,day_of_year,WOCE_flag,fCO2_source,region_id,data_id,tmonth,lon360&time>=1968-11-16T22:00:00Z&time<=2008-01-01T00:00:00Z&orderBy(\"cruise_expocode,time\")";
