 ...
 * container Widget.
 */
public class OutputControlPanelActivity extends AbstractActivity implements OutputControlPanel.Presenter {
        ...
        eventBus.addHandler(StringValueChangeEvent.TYPE, new StringValueChangeEvent.Handler() {
            ...
            public void onValueChange(StringValueChangeEvent event) {
                ...
                if ( (source != null) && (source instanceof HasName) ) {
                    ...
                    if ( view.getName().equalsIgnoreCase(namedSource.getName()) ) {
                        String imageURL = event.getValue();
                        view.setImageURL(imageURL);
                        view.getDisplayButton().setEnabled(imageURL != null);
                    }
                }
            }
        });
