 ...
 *
 */
public class AddVariableConstraintEvent extends GwtEvent<AddVariableConstraintEvent.Handler> {
    private String lhs;
    private String op1;
    ...
    public static final Type<AddVariableConstraintEvent.Handler> TYPE = new Type<AddVariableConstraintEvent.Handler>();
    /**
    ...
    public interface Handler extends EventHandler {
        void onAdd(AddVariableConstraintEvent event);
    }
    ...
    public static Type<AddVariableConstraintEvent.Handler> getType() {
        return TYPE;
    }
