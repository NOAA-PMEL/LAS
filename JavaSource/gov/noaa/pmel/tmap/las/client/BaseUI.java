...
public class BaseUI {
    ...
    PushButton xHideControls = new PushButton("Hide Controls", new ClickHandler() {
    ...
    PushButton xShowControls = new PushButton("Show Controls", new ClickHandler() {
        ...
        if ( xPanelCount > numPanels ) {
            ...
            for ( int i = xPanelCount; i < numPanels; i++ ) {
                ...
                OutputPanel panel = new OutputPanel(title, compare_panel,
                        ...
                        xContainerType, xTileServer, annotationsControl.isDown());
