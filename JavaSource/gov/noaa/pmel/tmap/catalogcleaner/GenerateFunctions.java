...
class GenerateFunctions {
    ...
    public static void main(String[] args) throws Exception{
		...
		BufferedReader br = new BufferedReader(new FileReader("tables_columns.txt"));
		...
		for(int i = 0; i<args.length; i++){
			if(args[i].equals("f")){
				doFunctions = true;
				bw_insert_functions = new BufferedWriter(new FileWriter("insert_functions.sql"));
				bw_update_functions = new BufferedWriter(new FileWriter("update_functions.sql"));
				bw_delete_functions = new BufferedWriter(new FileWriter("delete_functions.sql"));
				// go ahead and write the drop functions too, you never know when you will need them
				dropFunctions = true;
				bw_dropfunctions = new BufferedWriter(new FileWriter("dropfunctions.sql"));
			}
			else if(args[i].equals("m")){
				doMethods = true;
				bw_insert_methods = new BufferedWriter(new FileWriter("insert_methods.java"));
				bw_update_methods = new BufferedWriter(new FileWriter("update_methods.java"));
				bw_delete_methods = new BufferedWriter(new FileWriter("delete_methods.java"));
				bw_get_methods = new BufferedWriter(new FileWriter("get_methods.java"));
			}
			else if(args[i].equals("d")){
				dropFunctions = true;
				bw_dropfunctions = new BufferedWriter(new FileWriter("dropfunctions.java"));
			}
		...
		try{
			...
			if(doFunctions){
				...
				bw_functions = new BufferedWriter(new FileWriter("functions.sql"));
				br_functions = new BufferedReader(new FileReader("insert_functions.sql"));
				while ((oneline=br_functions.readLine()) != null) {
					bw_functions.write(oneline + "\n");
				}
				br_functions.close();
				bw_functions.write("\n\n");
				br_functions = new BufferedReader(new FileReader("update_functions.sql"));
				while ((oneline=br_functions.readLine()) != null) {
					bw_functions.write(oneline + "\n");
				}
				br_functions.close();
				bw_functions.write("\n\n");
				br_functions = new BufferedReader(new FileReader("delete_functions.sql"));
				while ((oneline=br_functions.readLine()) != null) {
					bw_functions.write(oneline + "\n");
				}
				br_functions.close();
			...
			if(doMethods){
				...
				br_methods = new BufferedReader(new FileReader("DataAccessStub.java"));
				...
				br_methods.close();
				bw_methods.write("\n\n\t/*begin get methods*/\n\n");
				br_methods = new BufferedReader(new FileReader("get_methods.java"));
				while ((oneline=br_methods.readLine()) != null) {
					bw_methods.write(oneline + "\n");
				}
				br_methods.close();
				bw_methods.write("\n\n\t/*begin insert methods*/\n\n");
				br_methods = new BufferedReader(new FileReader("insert_methods.java"));
				while ((oneline=br_methods.readLine()) != null) {
					bw_methods.write(oneline + "\n");
				}
				br_methods.close();
				...
				br_methods = new BufferedReader(new FileReader("update_methods.java"));
				while ((oneline=br_methods.readLine()) != null) {
					bw_methods.write(oneline + "\n");
				}
				br_methods.close();
				...
				br_methods = new BufferedReader(new FileReader("delete_methods.java"));
				while ((oneline=br_methods.readLine()) != null) {
					bw_methods.write(oneline + "\n");
				}
				bw_methods.write("}\n");
