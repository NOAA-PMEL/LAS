...
// NOTE:  This for loop is picking up the otoJSONString() method added to all 
// NOTE:  objects by the json.js library.  The fix is described here:
// NOTE:  http://yuiblog.com/blog/2006/09/26/for-in-intrigue/
// NOTE:  and requires the !== 'function' test
    for (var a in this.attributes) {
      if (typeof this.attributes[a] !== 'function') {
