/* vim: ts=8:sw=4
 *
 * $Id: DBI.xs,v 1.1.1.1 2005/02/07 19:37:43 callahan Exp $
 *
...
static SV	 *dbih_make_com	   _((SV *parent_h, imp_xxh_t *p_imp_xxh, char *imp_class, STRLEN imp_size, STRLEN extra, SV *copy));
