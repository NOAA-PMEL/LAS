...
$VERSION = sprintf("%d.%02d", q$Revision: 1.1.1.1 $ =~ /(\d+)\.(\d+)/o);

# $Id: DBD.pm,v 1.1.1.1 2005/02/07 19:37:47 callahan Exp $
#
...
common). For RCS or CVS you can use this code:
  ...
  $VERSION = sprintf "%d.%02d", '$Revision: 1.1.1.1 $ ' =~ /(\d+)\.(\d+)/;
